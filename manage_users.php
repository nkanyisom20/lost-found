    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <?php } ?>
          <?php if ($role == 'Student') { ?>
          <div class="page-heading"> <i class="glyphicon glyphicon-wrench"></i> View Users</div>
          <?php } ?>
        </div> <!-- /panel-heading -->
              ...
              <table  class="table table-bordred table-striped">
                ...
                <tbody>
                  <?php
                      ...
                      $result_count = mysqli_query($connect,"SELECT COUNT(*) As total_records FROM `student_reg`");
                      ...
                      $count=1;
                      $result = mysqli_query($connect,"SELECT * FROM `student_reg` ORDER BY `date_registered` DESC LIMIT $offset, $total_records_per_page");
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a class="reset_student_no" data-emp-id="<?php echo $row["stu_reg_id"]; ?>" href="javascript:void(0)">
            						  <button class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit"></span></button>
            							</a>
                        </td>
                        <td>
            							<a class="update_student_no" data-emp-id="<?php echo $row["stu_reg_id"]; ?>" href="javascript:void(0)">
            						  <button class="btn btn-success btn-xs"><span class="glyphicon glyphicon-ok-sign"></span></button>
            							</a>
                        </td>
                        <td>
            							<a class="remove_student_no" data-emp-id="<?php echo $row["stu_reg_id"]; ?>" href="javascript:void(0)">
...
<script type="text/javascript" src="js_crud_script/removeRecords.js"></script>
<script type="text/javascript" src="js_crud_script/updateRecords.js"></script>
<script type="text/javascript" src="js_crud_script/resetRecords.js"></script>
